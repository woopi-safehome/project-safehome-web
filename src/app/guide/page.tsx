...
export const metadata: Metadata = {
  ...
  description: "등기부등본 PDF 받는 법부터 분석 결과 읽는 법, 주의사항까지 안내합니다.",
};
...
export default function GuidePage() {
  return (
    <main>
      <section className="border-b border-line bg-gradient-to-b from-brand-soft/70 to-canvas">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-4 px-4 py-14 text-center sm:px-6">
          <p className="text-sm font-semibold text-brand">이용 방법</p>
          <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">처음이어도 어렵지 않아요</h1>
          <p className="max-w-xl text-base leading-relaxed text-muted">
            등기부등본을 받는 법부터 결과를 읽고 계약 전에 챙길 일까지, 순서대로 안내해 드릴게요.
          </p>
        </div>
      </section>
